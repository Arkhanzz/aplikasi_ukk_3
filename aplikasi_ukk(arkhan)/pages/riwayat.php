        ...
        <div class="table-responsive"><table class="table table-hover align-middle mb-0" id="riwayatTable">
            ...
            <tbody>
                ...
                <tr data-tanggal="<?= date('Y-m-d',strtotime($r['waktu_keluar'])) ?>" data-jenis="<?= $jns ?>" data-plat="<?= strtolower($r['plat_nomor']) ?>" data-pemilik="<?= strtolower($r['pemilik']) ?>">
                    ...
                    <td><small class="badge bg-dark"><?= $int->format('%h j %i m') ?></small></td>
...
<style>
    .bg-gradient-primary{background:linear-gradient(135deg, #424e27 0%, #dab45c 100%)} 
    .bg-gradient-success{background:linear-gradient(135deg, #5b6426 0%, #dab45c 100%)}
    .bg-gradient-warning{background:linear-gradient(135deg, #6e8a0b 0%, #dab45c 100%)}
    .bg-gradient-info{background:linear-gradient(135deg, #708504 0%, #dab45c 100%)}
