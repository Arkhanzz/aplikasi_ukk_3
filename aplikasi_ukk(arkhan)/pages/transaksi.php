...
foreach ($transaksi as $r) {
    ...
    $biaya = $durasiJam * $r['tarif_per_jam'];
            ...
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body p-0"><div class="table-responsive" style="max-height: 680px;">
                    <table class="table table-hover mb-0">
                        <thead class="bg-light sticky-top"><tr class="table-primary"><th class="ps-4">Waktu</th><th>Kendaraan</th><th>Jenis</th><th>Pemilik</th><th class="text-center">Area</th><th class="text-center">Biaya</th><th class="text-center pe-4">Aksi</th></tr></thead>
                        <tbody>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center text-success fw-bold">Rp <?= number_format($biaya, 0, ',', '.') ?></td>
