...
$totalTransaksi = mysqli_num_rows(mysqli_query($conn, "SELECT 1 FROM tb_transaksi"));
    ...
    <div class="row g-4">
            ...
            <div class="card border-0 shadow-sm p-3 text-center" style="border-radius:15px; height:100%;">
                ...
                <div class="position-relative mx-auto mb-3" style="width:120px; height:120px;">
                    ...
                    <div class="position-absolute top-50 start-50 translate-middle">
                        <h5 class="mb-0 fw-bold"><?= $totalMobil+$totalMotor ?></h5><small class="text-muted">Total</small>
                    </div>
                </div>
        ...
        <div class="col-md-3">
            <div class="d-grid gap-2">
                ...
                <a href="?page=transaksi" class="btn btn-gradient-primary py-3 border-0 text-white shadow-sm" style="border-radius:12px;"><i class="bi bi-plus-circle me-2"></i>Masuk Parkir</a>
                <a href="?page=transaksi" class="btn btn-white py-3 shadow-sm" style="border-radius:12px; border:1px solid #eee;"><i class="bi bi-box-arrow-right me-2"></i>Keluar Parkir</a>
                <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new Chart(document.getElementById('revenueChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#dee134', backgroundColor: 'rgba(234, 183, 102, 0.1)', fill: true, tension: 0.3
            }]
        },
    ...
    new Chart(document.getElementById('vehicleChart'), {
        ...
        data: {
            labels: ['Mobil', 'Motor'],
            datasets: [{ data: [<?= $totalMobil ?>, <?= $totalMotor ?>], backgroundColor: ['#eaba66', '#85b817'], borderWidth: 0 }]
        },
...
<style>
    .bg-gradient-primary { background: linear-gradient(135deg, #d2e650, #dab45c); }
    .bg-gradient-success { background: linear-gradient(135deg, #a9c93e, #f0bd2e); } 
    .bg-gradient-warning { background: linear-gradient(135deg, #a0ba0f, #b17e2a); }
    .bg-gradient-info { background: linear-gradient(135deg, #959040, #b5641c); }
    .btn-gradient-primary { background: linear-gradient(135deg, #dada3f, #ea8615); }
