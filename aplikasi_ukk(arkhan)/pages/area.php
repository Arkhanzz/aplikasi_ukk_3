...
$e=null;
if(isset($_GET['edit'])){
  $e=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM tb_area_parkir WHERE id_area='$_GET[edit]'"));
}
?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1 text-darkz">Manajemen Area Parkir</h4>
            ...
            <form method="POST" action="process/aksi.php" class="row g-4">
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input class="form-control border-start-0 ps-2" name="kapasitas" 
                               placeholder="Jumlah maksimal kendaraan" 
                               value="<?= $e['kapasitas']??'' ?>" required
                               style="height: 50px;">
...
<style>
    ...
    .btn-gradient-primary {
        background: linear-gradient(135deg, #fff00f 0%, #dab45c 100%);
        border: none;
        color: white;
    }
    ...
    input:focus, select:focus {
        border-color: #eadd66 !important;
        box-shadow: 0 0 0 0.25rem rgba(203, 234, 102, 0.63) !important;
    }
    
    .alert {
        border-radius: 12px;
        border: none;
        background-color: rgba(206, 240, 13, 0.1);
    }
