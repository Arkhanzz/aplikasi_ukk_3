...
<style>
    ...
    .navbar {
        ...
        background: linear-gradient(135deg, #d2d427 0%, #c8930e 100%) !important;
    }
    ...
    .nav-link.active {
        ...
        color: #ede552 !important;
        box-shadow: 0 2px 8px rgba(196, 133, 7, 0.15);
    }
    ...
    .dropdown-menu {
        border: none;
        border-radius: 12px;
        box-shadow: 0 4px 16px rgba(159, 177, 18, 0.66);
        padding: 0.5rem 0;
        margin-top: 0.5rem;
    }
    ...
    .dropdown-item:hover {
        background-color: rgba(234, 210, 102, 0.15);
        color: #ede552;
    }
