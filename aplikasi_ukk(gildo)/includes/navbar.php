<div class="container-fluid px-0" style="overflow: visible !important;">
    <!-- Top Navigation Bar -->
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm sticky-top" style="overflow: visible !important; z-index: 999;">
        <div class="container-fluid px-4" style="overflow: visible !important;">
            <!-- Logo & Brand -->
            ...
            <!-- Navigation Content -->
            <div class="collapse navbar-collapse" id="navbarContent" style="overflow: visible !important;">
                <!-- Menu Items -->
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="overflow: visible !important;">
                    <!-- Dashboard -->
                    ...
                    <!-- Admin Menu -->
                    <?php if($role=='admin'): ?>
                        <li class="nav-item dropdown mx-1" style="position: relative;">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="adminDropdown" style="position: absolute; top: 100%; left: 0; min-width: 200px; z-index: 9999;">
                                <li>
...
<style>
    ...
    .navbar {
        ...
        background: linear-gradient(90deg, #1f246b 0%, #070614 100%) !important;
...
<script>
// Custom dropdown handler - Click to toggle, stay open
document.addEventListener('DOMContentLoaded', function() {
    const adminDropdown = document.getElementById('adminDropdown');
    const adminMenu = adminDropdown ? adminDropdown.parentElement.querySelector('.dropdown-menu') : null;

    if (adminDropdown && adminMenu) {
        // Click on toggle button to show/hide dropdown
        ...
        adminMenu.addEventListener('mouseleave', function() {
            // Don't auto-close on mouseleave
        });

        // Close dropdown when clicking a menu item
        const menuItems = adminMenu.querySelectorAll('.dropdown-item');
    ...
    document.addEventListener('click', function(e) {
        if (adminMenu && !adminDropdown.contains(e.target) && !adminMenu.contains(e.target)) {
            adminMenu.classList.remove('show');
        }
    });

    // Initialize Bootstrap dropdowns for other dropdowns if needed
    const otherDropdowns = document.querySelectorAll('[data-bs-toggle="dropdown"]:not(#adminDropdown)');
    otherDropdowns.forEach(toggle => {
