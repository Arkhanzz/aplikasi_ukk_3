                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php foreach($transaksi as $r): 
                                ...
                                $biayaRealtime = $durasiJam * $tarifPerJam;
                            ?>
                            <tr class="align-middle" data-waktu-masuk="<?= strtotime($r['waktu_masuk']) ?>" data-tarif="<?= $tarifPerJam ?>">
                                ...
                                <td class="text-center"><span class="badge bg-info text-info bg-opacity-10 border border-info"><?= $r['nama_area'] ?: '<em>Area dihapus</em>' ?></span></td>
                                <td class="text-center"><small class="text-muted fw-bold"><?= $durasiJam ?> jam</small><br><small class="text-primary">Rp <?= number_format($tarifPerJam, 0, ',', '.') ?>/jam</small></td>
