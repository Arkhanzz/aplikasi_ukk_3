...
$transaksiTerakhir = mysqli_fetch_all(mysqli_query($conn, "SELECT t.*, k.plat_nomor, k.jenis_kendaraan, a.nama_area FROM tb_transaksi t JOIN tb_kendaraan k ON t.id_kendaraan = k.id_kendaraan LEFT JOIN tb_area_parkir a ON t.id_area = a.id_area ORDER BY t.waktu_masuk DESC LIMIT 5"), MYSQLI_ASSOC);
                ...
                <div class="table-responsive"><table class="table table-sm align-middle small">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $t['nama_area'] ?: '<em class="text-muted">Area dihapus</em>' ?></td>
